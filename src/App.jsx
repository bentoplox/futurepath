    ...
    if (showRegisterScreen) {
      return (
        <Register
          ...
          onSwitchToLogin={() => { setShowRegisterScreen(false); setShowLoginScreen(true); }}
          onRegisterSuccess={() => setShowRegisterScreen(false)}
          onBack={() => setShowRegisterScreen(false)} // ⚡ Passes back action directly to the card
        />
      );
    }
    if (showLoginScreen) {
      return (
        <Login
          onSwitchToRegister={() => { setShowLoginScreen(false); setShowRegisterScreen(true); }}
          onLoginSuccess={() => { }}
          onBack={() => setShowLoginScreen(false)} // ⚡ Passes back action directly to the card
        />
      );
    }
